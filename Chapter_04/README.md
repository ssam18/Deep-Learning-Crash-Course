...
**Notebook**: [`Chapter_04_Convolutional_Neural_Networks.ipynb`](Chapter_04_Convolutional_Neural_Networks.ipynb)
...
jupyter lab Chapter_04_Convolutional_Neural_Networks.ipynb
```
